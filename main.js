...
function atualiza() {
    $(this).css('background-color', 'rgb(240,240,240,0)');
    valor = $('#valor').text();
    valor = valor.replace(',','.');
    setTimeout(function(){
        $('.col').css('background-color', '#dde9f5');
        $('.numeros').css('background-color', 'rgb(250, 250, 250)');
    },100);
    $('.col').hover(function(){
        $(this).css('background-color', '#fff');
    }, function(){
        $(this).css('background-color', '#dde9f5');
    });
...
$(document).on('click', '#fe', function() {
    if(fe) {
        ...
        fe = true;
        this.style.borderBottom = "3px solid #22076b";
    }
});
...
$(document).on('click', '#memoria', function(){
    ...
    document.getElementById('mem').style.borderBottom = "3px solid #22076b";
...
$(document).on('click', '#historico', function() {
    ...
    while(historicoLocal.includes(','))
        historicoLocal = historicoLocal.replace(',','<br>');
    $('#div-historico').html(historicoLocal);
    $('#his').css('borderBottom', '3px solid #22076b');
